...
This background behavior is in-app: closing the app stops the running renderer task. Existing Fibonacci AI task ids remain available to the image-generation resume flow.
