...
- Text: `All areas`, `Area`, `Components`, `Desktop-specific`, `Detected State Checklist`, `Live Previews`, `Markdown`, `Missing fixtures`, `Missing real fixture`, `Modals`, `No explicit component states were detected in source.`, `No inventory entries match the current filters.`, `No preview target selected.`, `Pages`, `Platform Notes`, `Platform Signal`, `Platform Signals`, `Preview Data`, `Preview Modes`, `Real component preview`, `Real previews`, `Real rendered preview`, `Search`, `Search path, component, state, variant, or text`, `States`, `Stories`, `Storybook links require `bun run storybook` on port 6006.`, `Text`, `UI Inventory`, `UI TSX files`, `Variants`
...
- Text: `AI-generated images may not be accurate. Review output carefully.`, `Describe the image you want to create...`, `History`, `Image Creator`, `New Creation`, `No models available`, `Please log in to Fibonacci AI first`, `Please select a model`, `Resume Generation`, `Upload`
...
- Text: `{{count}} lines`, `Advanced Mode`, `Fibonacci AI Service`, `Due to local processing limitations, <Link>Fibonacci AI Service</Link> is recommended for enhanced document processing capabilities and better results.`, `Due to local processing limitations, <Link>Fibonacci AI Service</Link> is recommended to enhance webpage parsing capabilities, especially for dynamic pages.`, `Loading webpage...`, `Local Mode`, `Preparing`, `Preparing tool call`, `Reading file...`, `Retrying {{attempt}}/{{maxAttempts}}`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Fibonacci AI error message quota license file and web browsing states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-ai-error-message-quota-license-file-and-web-browsing-states)
...
- Text: `Claim Free Plan`, `Login Fibonacci AI`, `Login to start chatting with AI`, `No licenses found`, `Other options`, `Purchase Plan`, `View License Details`, `View More Plans`, `Welcome to Chatbox!`
...
- Text: `Add`, `Are you sure you want to delete the knowledge base`, `Cancel`, `Create`, `Create First Knowledge Base`, `Create Knowledge Base`, `Create your first knowledge base to start adding documents and enhance your AI conversations with contextual information.`, `Delete`, `Delete Knowledge Base`, `Edit`, `Edit Knowledge Base`, `Embedding`, `Failed to create knowledge base, Error: {{error}}`, `Failed to fetch Fibonacci AI models config, Error: {{error}}`, `Failed to fetch knowledge base list, Error: {{error}}`, `Failed to update knowledge base, Error: {{error}}`, `Knowledge Base`, `Knowledge Base functionality is not available on Windows ARM64 due to library compatibility issues. This feature is supported on Windows x64, macOS, and Linux.`, `Local`, `Log in to Fibonacci AI`, `Models`, `Name`, `No Knowledge Base Yet`, `None`, `Parser`, `Platform Not Supported`, `Provider unavailable`, `Rerank`, `Save`, `Sign in to Fibonacci AI`, `Sign in to Fibonacci AI to use this knowledge base`, `This action cannot be undone. All documents and their embeddings will be permanently deleted.`, `Unknown`, `Vision`, `Your Fibonacci AI knowledge base requires an active login. Please sign in to Fibonacci AI to use this knowledge base.`
...
- Text: `All`, `Auto`, `Fibonacci AI`, `Favorite`, `Model details`, `No eligible models available`, `No favorite models`, `Search models`, `Select Model`
...
- Variants: `size:sm`, `size:xs`
- Text: `Builtin MCP Servers`, `One-click MCP servers for Fibonacci AI subscribers`
...
- Text: `Claim Free Plan`, `Confirm`, `For general conversations, please click`, `Login Successful`, `Login to Fibonacci AI`, `New Chat`, `on the side bar to start a new conversation.`, `Opening a new chat...`, `Select License`, `Set up API`, `Sit back, relax. Chatbox will start a new chat in {{count}}s...`, `This is the onboarding assistant`, `View License Details`, `You have multiple licenses. Please select one to use:`
...
- Variants: `size:sm`, `size:xs`
- Text: `I know how to configure API keys`, `Recommended`, `Skip guide`, `Use Fibonacci AI service`
...
- Text: `By continuing, you agree to our`, `Cancel`, `Email`, `Enter the 6-digit verification code we sent to your email.`, `If no account exists, it will automatically create one.`, `Login to Fibonacci AI`, `name@example.com`, `Privacy Policy`, `Promise`, `Read our`, `Resend in {{count}}s`, `Send Code`, `Terms of Service`, `Verification Code`, `Verification failed`, `Verify and Log in`
...
- Text: `Fibonacci AI`, `Claim Free Plan`, `Continue with`, `Email`, `Expired`, `Expires`, `Failed to activate license, please check your license key and network connection`, `Failed to load account data. Please try again.`, `Failed to load license details`, `get more`, `License expired, please check your license key`, `license key`, `License not found, please check your license key`, `Loading license details...`, `Loading...`, `Log out`, `Manage License`, `No expiration`, `No licenses found. Please purchase a license to continue.`, `Retry`, `Select a license`, `Selected Key`, `Switching license...`, `This license key has reached the activation limit.`, `View More Plans`, `You have no more Fibonacci AI quota left this month.`, `You have no more Fibonacci AI quota left today.`, `Your license has expired.`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Fibonacci AI login view real account entry states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--chatbox-ai-login-view-real-account-entry-states)
- States: `loginModalOpened`, `opened`
- Variants: `outline`, `size:sm`
- Text: `By continuing, you agree to our`, `Fibonacci AI offers a user-friendly AI solution to help you enhance productivity`, `Continue with`, `Get License`, `Hassle-free setup`, `Ideal for work and study`, `license key`, `Log in to your Chatbox account`, `Login`, `Privacy Policy`, `Promise`, `Read our`, `Retrieve License`, `Smartest AI-Powered Services for Rapid Access`, `Terms of Service`, `Vision, Drawing, File Understanding and more`, `Welcome to Chatbox`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Avatar user assistant system chat picture states](http://localhost:6006/?path=/story/real-components-common-feedback--avatar-user-assistant-system-chat-picture-states), [Storybook: Fibonacci AI error message quota license file and web browsing states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-ai-error-message-quota-license-file-and-web-browsing-states), [Storybook: Chatbox welcome card login no-license and expired states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-welcome-card-login-no-license-and-expired-states), [Storybook: Compression modal opened confirmation state](http://localhost:6006/?path=/story/real-components-common-feedback--compression-modal-opened-confirmation-state), [Storybook: Error boundary fallback and retry states](http://localhost:6006/?path=/story/real-components-common-feedback--error-boundary-fallback-and-retry-states), [Storybook: Divider link mark scalable icon and segmented control states](http://localhost:6006/?path=/story/real-components-common-feedback--divider-link-mark-scalable-icon-and-segmented-control-states), [Storybook: Toast stack top-right feedback states](http://localhost:6006/?path=/story/real-components-common-feedback--toast-stack-top-right-feedback-states)
- States: `error`, `opened`, `segment`, `success`
- Variants: `size:lg`, `size:sm`, `size:xs`
- Text: `Actual account/license welcome card variants shown on empty chat and image creator surfaces.`, `Actual conversation compression confirmation modal used before forced context compaction.`, `Actual global toast renderer backed by the shared UI store.`, `Actual localized Fibonacci AI service error copy with settings, plan, homepage, and parser action links.`, `Actual Sentry-backed error boundary with the default app fallback, retry, reload, and details states.`, `Actual user, assistant, system, chat, and picture avatar variants used in session and message rows.`, `Actual utility components used throughout settings, message content, and toolbar controls.`, `Assistant`, `Avatar`, `Avatar user assistant system chat picture states`, `Chat icon`, `Fibonacci AI error message quota license file and web browsing states`, `Chatbox homepage link`, `Chatbox welcome card login no-license and expired states`, `ChatboxAIErrorMessage`, `ChatboxWelcomeCard`, `Compression modal opened confirmation state`, `CompressionModal`, `Divider link mark scalable icon and segmented control states`, `Error boundary fallback and retry states`, `ErrorBoundary`, `Inline common utilities`, `Long support conversation`, `Open compression modal`, `Picture`, `System`, `Toast stack top-right feedback states`, `Toast store is populated; notifications render in the production Snackbar stack.`, `Toasts`, `User`, `Vertical divider`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Email code login modal email and verification states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--email-code-login-modal-email-and-verification-states), [Storybook: License detail card active expired quota and reward states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-detail-card-active-expired-quota-and-reward-states), [Storybook: License key view inactive activation and purchase states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-key-view-inactive-activation-and-purchase-states), [Storybook: License selection modal active expired and quota states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-selection-modal-active-expired-and-quota-states), [Storybook: Logged in account selected license and quota states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--logged-in-account-selected-license-and-quota-states), [Storybook: Fibonacci AI login view real account entry states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--chatbox-ai-login-view-real-account-entry-states), [Storybook: Model management list fetch reset add remove states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--model-management-list-fetch-reset-add-remove-states)
- States: `active`, `opened`, `selected`
- Variants: `size:sm`, `size:xs`
- Text: `Active plan`, `Actual Fibonacci AI account login entry with promotion and license-key fallback.`, `Actual Fibonacci AI model management list with reset, fetch, delete, and fetched-model modal states.`, `Actual email-code login modal with email, code, terms, cancel, and verify actions.`, `Actual logged-in Fibonacci AI account state with license selector, quota details, logout, and plan actions.`, `Actual manual license-key entry state with Fibonacci AI value proposition and purchase/retrieve actions.`, `Actual modal shown when an account has multiple licenses to choose from.`, `Actual quota card used by manual and logged-in license states.`, `Fibonacci AI login view real account entry states`, `Fibonacci AI Pro`, `Fibonacci AI Team Trial`, `Click Fetch in the preview to open the production fetched-model modal state.`, `Email code login modal email and verification states`, `EmailCodeLoginModal`, `Expired and empty quota`, `License detail card active expired quota and reward states`, `License key view inactive activation and purchase states`, `License selection modal active expired and quota states`, `LicenseDetailCard`, `LicenseKeyView`, `LicenseSelectionModal`, `Logged in account selected license and quota states`, `LoggedInView`, `LoginView`, `Model management list fetch reset add remove states`, `ModelManagement`
