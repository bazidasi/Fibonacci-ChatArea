...
export default class MenuBuilder {
  ...
  buildDarwinTemplate(): MenuItemConstructorOptions[] {
    const subMenuAbout: DarwinMenuItemConstructorOptions = {
      label: 'Fibonacci Chat Area',
      submenu: [
        {
          label: 'About Fibonacci Chat Area',
        ...
        { type: 'separator' },
        {
          label: 'Hide Fibonacci Chat Area',
      ...
      submenu: [
        {
          label: 'Learn More',
          click() {
            shell.openExternal('https://my.fibonacci.monster/user/dashboard')
          },
        },
        {
          label: 'Fibonacci Dashboard',
          click() {
            shell.openExternal('https://my.fibonacci.monster/user/dashboard')
          },
        },
        ...
        // },
        {
          label: 'API Tokens',
          click() {
            shell.openExternal('https://my.fibonacci.monster/user/api-tokens')
          },
        },
      ],
    }
