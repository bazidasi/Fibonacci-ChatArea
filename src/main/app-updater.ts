...
export class AppUpdater {
  ...
  async tryUpdate() {
    // Fibonacci Chat Area: upstream (Fibonacci AI) auto-update feeds are disabled.
    // This fork is distributed independently; automatic updates would otherwise
    // overwrite it with the upstream build.
    log.info('auto_updater: disabled in Fibonacci Chat Area fork')
    return null
  }
}
