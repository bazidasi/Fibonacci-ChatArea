...
describe('ChatboxAI openai-responses models', () => {
  ...
  it('creates an OpenAI Responses gateway provider with Fibonacci AI auth headers', () => {
    const model = createModel({
      modelId: 'gpt-5-mini',
      type: 'chat',
      apiStyle: 'openai-responses',
  ...
  it('marks normal Fibonacci AI requests as outside agent mode', () => {
    const model = createModel({
      modelId: 'gpt-5-mini',
      type: 'chat',
      apiStyle: 'openai-responses',
...
describe('ChatboxAI anthropic max output tokens', () => {
  it('defaults Fibonacci AI Anthropic models to 8192 max output tokens', () => {
    const model = createModel({
  ...
  it('keeps explicit max output tokens for Fibonacci AI Anthropic models', () => {
    const model = createModel(
      {
        modelId: 'claude-3-haiku-20240307',
        type: 'chat',
  ...
  it('does not add the Anthropic default to non-Anthropic Fibonacci AI models', () => {
    const model = createModel({
      modelId: 'gpt-5-mini',
      type: 'chat',
      apiStyle: 'openai-responses',
