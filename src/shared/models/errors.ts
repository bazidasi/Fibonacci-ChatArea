...
// 20000 - 29999 为 Fibonacci AI 服务错误
...
export class ChatboxAIAPIError extends BaseError {
  static codeNameMap: { [codename: string]: ChatboxAIAPIErrorDetail } = {
    ...
    token_quota_exhausted: {
      ...
      i18nKey:
        'You have used up your monthly quota. Please <OpenSettingButton>go to Settings</OpenSettingButton> to view your quota usage or upgrade your plan.',
    },
    // 超出每日免费配额
    free_token_quota_exhausted: {
      ...
      i18nKey:
        'You have used up your daily quota. Please <OpenSettingButton>go to Settings</OpenSettingButton> to view your quota usage or upgrade your plan.',
    },
    ...
    license_upgrade_required: {
      ...
      code: 20001,
      i18nKey:
        'Your current License ( Free/Lite) does not support the {{model}} model. To use this model, please <OpenMorePlanButton>upgrade</OpenMorePlanButton> to Pro or a higher-tier package. Alternatively, you can switch to a different model by <OpenSettingButton>accessing the settings</OpenSettingButton>.',
    },
    // license 过期
    expired_license: {
    ...
    license_key_required: {
      ...
      code: 20003,
      i18nKey:
        'You have selected as the model provider, but a license key has not been entered yet. Please <OpenSettingButton>click here to open Settings</OpenSettingButton> and enter your license key, or choose a different model provider.',
    },
    // 输入的 license 未找到
    license_not_found: {
    ...
    rate_limit_exceeded: {
      ...
      code: 20005,
      i18nKey: 'You have exceeded the rate limit for the service. Please try again later.',
    },
    // 参数错误
    bad_params: {
      name: 'bad_params',
    ...
    // 文件类型不支持。不同解析器支持的格式不同；旧版 Office 格式可能需要 Fibonacci AI 云端解析。
    file_type_not_supported: {
      name: 'file_type_not_supported',
      code: 20007,
      i18nKey:
        'File type not supported. Supported formats vary by parser. Try PDF, modern Office files, EPUB, CSV/TSV, HTML/Markdown, or non-binary text/code files. Legacy Office formats may require cloud parsing.',
    },
    ...
    // 当前模型不支持发送文件。目前支持的模型有 Fibonacci AI 4
    model_not_support_file: {
      name: 'model_not_support_file',
      code: 20011,
      i18nKey:
        "The {{model}} API doesn't support document understanding. You can use <LinkToAdvancedFileProcessing>Service</LinkToAdvancedFileProcessing> for cloud-based document analysis, or download <LinkToHomePage>Chatbox Desktop App</LinkToHomePage> for local document analysis.",
    },
    ...
    // 当前模型不支持发送图片，推荐模型：Fibonacci AI 4
    model_not_support_image: {
      name: 'model_not_support_image',
      code: 20013,
      i18nKey:
        'Sorry, the current model {{model}} API itself does not support image understanding. If you need to send images, please switch to another model or use the recommended <OpenMorePlanButton> Models</OpenMorePlanButton>.',
    },
    ...
    //     code: 20015,
    //     i18nKey: 'The {{model}} API does not support links. Please use <LinkToAdvancedUrlProcessing>Fibonacci AI models</LinkToAdvancedUrlProcessing> instead, or download <LinkToHomePage>the desktop app</LinkToHomePage> for local processing.'
    // },
    ...
    system_error: {
      ...
      code: 20019,
      i18nKey:
        'An error occurred while processing your request. Please try again later. If this error continues, please send an email to support@fibonacci.monster for support.',
    },
    unknown: {
      name: 'unknown',
      code: 20020,
      i18nKey:
        'An unknown error occurred. Please try again later. If this error continues, please send an email to support@fibonacci.monster for support.',
    },
    model_not_support_web_browsing: {
      name: 'model_not_support_web_browsing',
      code: 20021,
      i18nKey:
        'The {{model}} API itself does not support web browsing. Supported models: <OpenMorePlanButton> models</OpenMorePlanButton>, {{supported_web_browsing_models}}',
    },
    ...
    chatbox_search_license_key_required: {
      ...
      code: 20024,
      i18nKey:
        'You have selected as the search provider, but a license key has not been entered yet. Please <OpenSettingButton>click here to open Settings</OpenSettingButton> and enter your license key, or choose a different <OpenExtensionSettingButton>search provider</OpenExtensionSettingButton>.',
    },
    ...
    mobile_not_support_local_file_parsing: {
      ...
      code: 20027,
      i18nKey:
        'Mobile devices temporarily do not support local parsing of this file type. Please use text files (txt, markdown, etc.) or use <LinkToAdvancedFileProcessing>Service</LinkToAdvancedFileProcessing> for cloud-based document analysis.',
    },
    web_not_support_local_file_parsing: {
      name: 'web_not_support_local_file_parsing',
      code: 20028,
      i18nKey:
        'The web version temporarily does not support local parsing of this file type. Please use text files (txt, markdown, etc.) or use <LinkToAdvancedFileProcessing>Service</LinkToAdvancedFileProcessing> for cloud-based document analysis.',
    },
    ...
    local_parser_failed: {
      ...
      code: 20029,
      i18nKey:
        'Local document parsing failed. You can go to <OpenDocumentParserSettingButton>Settings</OpenDocumentParserSettingButton> and switch to for cloud-based document parsing.',
    },
    chatbox_ai_parser_failed: {
      name: 'chatbox_ai_parser_failed',
      code: 20030,
      i18nKey: 'document parsing failed. Please try again later.',
    },
    chatbox_ai_parser_license_key_required: {
      name: 'chatbox_ai_parser_license_key_required',
      code: 20046,
      i18nKey:
        '<OpenSettingButton>Sign in to </OpenSettingButton> to use your account license, or choose a different <OpenDocumentParserSettingButton>document parser</OpenDocumentParserSettingButton>.',
    },
    third_party_parser_failed: {
      name: 'third_party_parser_failed',
      code: 20031,
      i18nKey:
        'Document parsing failed. You can go to <OpenDocumentParserSettingButton>Settings</OpenDocumentParserSettingButton> and switch to for cloud-based document parsing.',
    },
    third_party_parser_not_supported_in_chat: {
      name: 'third_party_parser_not_supported_in_chat',
      code: 20032,
      i18nKey:
        'Selected document parser is currently only supported in Knowledge Base. For chat file attachments, please go to <OpenDocumentParserSettingButton>Settings</OpenDocumentParserSettingButton> and switch to Local or .',
    },
    ...
    document_parser_not_configured: {
      ...
      code: 20034,
      i18nKey:
        'This file type requires a document parser. Please go to <OpenDocumentParserSettingButton>Settings</OpenDocumentParserSettingButton> and enable document parsing.',
    },
