...
// Soft-UI libraries from awesome-neumorphism. ui-neumorphism ships global
// resets, so it must load BEFORE our own stylesheets (globals.css re-asserts).
...
import './static/neumorphism.css'
import './static/neumorphism-chat.css'
import './static/index.css'
import { initLogAtom, migrationProcessAtom } from './stores/atoms/utilAtoms'
import { runSplashIntro } from './lib/animations/neo-animations'
...
// GSAP splash intro: draw the fibonacci spiral while the app initializes.
runSplashIntro()
