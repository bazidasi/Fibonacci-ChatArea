...
describe('preprocessFile local parser fallback', () => {
  ...
  it('falls back to Fibonacci AI when local parsing throws and a license is active', async () => {
  ...
  it('falls back to Fibonacci AI when local parsing returns empty content and a license is active', async () => {
  ...
  it('rejects empty content returned by the Fibonacci AI fallback', async () => {
  ...
  it('falls back to Fibonacci AI for text files when local parsing fails', async () => {
  ...
  it('does not fall back to Fibonacci AI for pasted text when local processing fails', async () => {
  ...
  it('rejects empty local content for pasted text without falling back to Fibonacci AI', async () => {
  ...
  it('prompts for a license when Fibonacci AI parser is selected and local parsing fails without a key', async () => {
  ...
  it('uses local parsing first when Fibonacci AI parser is selected', async () => {
    parserState.type = 'chatbox-ai'
  ...
  it('falls back to Fibonacci AI when Fibonacci AI parser is selected and local parsing is unsupported', async () => {
    parserState.type = 'chatbox-ai'
