...
describe('settingsStore persistence', () => {
  ...
  it('migrates legacy Text Only document parser to Fibonacci AI on web and mobile', async () => {
    const persistedSettings = {
      extension: {
  ...
  it('uses Fibonacci AI as the default document parser on web and mobile', async () => {
