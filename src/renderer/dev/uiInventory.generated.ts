...
export const uiInventoryItems: UiInventoryItem[] = [
  ...
  },
  {
    ...
    text: [
      '{{count}} lines',
      'Advanced Mode',
      'Fibonacci AI Service',
      'Due to local processing limitations, <Link>Service</Link> is recommended for enhanced document processing capabilities and better results.',
      'Due to local processing limitations, <Link>Service</Link> is recommended to enhance webpage parsing capabilities, especially for dynamic pages.',
      'Loading webpage...',
      'Local Mode',
      'Preparing',
      'Preparing tool call',
  ...
  },
  {
    ...
    previewLinks: [
      {
        label: 'Storybook: Fibonacci AI error message quota license file and web browsing states',
        kind: 'storybook',
  ...
  },
  {
    ...
    text: [
      ...
      'This large file needs to finish indexing. Sign in to , then retry this file.',
      'Too large',
      'Too much text',
      'Unavailable',
    ],
  ...
  },
  {
    ...
    text: [
      ...
      'Failed to fetch models config, Error: {{error}}',
      ...
      'Save',
      'Sign in to',
      'Sign in to to use this knowledge base',
  ...
  },
  {
    ...
    platformNotes: [],
    previewModes: [],
    text: ['Builtin MCP Servers', 'One-click MCP servers for subscribers'],
    stories: [],
    storyNames: [],
    storyTargets: [],
    storybookIds: [],
  ...
  },
  {
    ...
    text: [
      ...
      'Actual localized Fibonacci AI service error copy with settings, plan, homepage, and parser action links.',
      ...
      'Chat icon',
      'Fibonacci AI error message quota license file and web browsing states',
  ...
  },
  {
    ...
    text: [
      ...
      'Reference URL',
      'Scanned contract',
      'Shows which parser produced each attachment (Local / Fibonacci AI / MinerU). Inline attachments show the parser in the subtitle; session-retrieval (indexed) attachments hide it to make room for index status — the full parser + index info is shown in the click preview window instead.',
      'Unsupported model',
  ...
  },
  {
    ...
    text: [
      ...
      'Actual form controls used for create/edit knowledge base flows, including provider mode, parser selection, model selectors, read-only parser display, Fibonacci AI info, and destructive edit actions.',
  ...
  },
  {
    ...
    text: [
      'Active plan',
      'Actual Fibonacci AI account login entry with promotion and license-key fallback.',
      'Actual Fibonacci AI model management list with reset, fetch, delete, and fetched-model modal states.',
      'Actual email-code login modal with email, code, terms, cancel, and verify actions.',
      'Actual logged-in Fibonacci AI account state with license selector, quota details, logout, and plan actions.',
      'Actual manual license-key entry state with Fibonacci AI value proposition and purchase/retrieve actions.',
      ...
      'Fibonacci AI login view real account entry states',
      'Fibonacci AI Pro',
      'Fibonacci AI Team Trial',
    ...
    storybookTitle: 'Real Components/Settings Fibonacci AI',
    storybookIds: [
    ...
    previewLinks: [
      ...
      {
        label: 'Storybook: Fibonacci AI login view real account entry states',
        kind: 'storybook',
  ...
  },
  {
    ...
    platformNotes: [],
    previewModes: [],
    text: ['I know how to configure API keys', 'Recommended', 'Skip guide', 'Use service'],
    stories: [],
    storyNames: [],
    storyTargets: [],
    storybookIds: [],
  ...
  },
  {
    ...
    text: [
      ...
      'Trigger Round Limit',
      'Type your -related question here',
    ],
    stories: [],
    storyNames: [],
    storyTargets: [],
  ...
  },
  {
    ...
    text: [
      ...
      'When selected, Chatbox will use this model instead of the automatic embedding model.',
      'When selected, Chatbox will use this model instead of the automatic reranking model.',
    ],
    stories: [],
    storyNames: [],
    storyTargets: [],
  ...
  },
  {
    ...
    text: [
      ...
      'Fibonacci AI',
      ' License',
      ' offers a user-friendly AI solution to help you enhance productivity',
      'Deactivate',
      'Expired',
      ...
      'You have no more quota left this month.',
      'You have no more quota left today.',
    ],
    stories: [],
    storyNames: [],
    storyTargets: [],
