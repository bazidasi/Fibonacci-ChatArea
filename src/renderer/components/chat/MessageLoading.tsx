      ...
      <div>
        ...
        {status.mode === 'local' && remoteConfig.setting_chatboxai_first && (
          <Typography variant="body2" sx={{ opacity: 0.5 }} className="pb-1">
            <Trans
              i18nKey="Due to local processing limitations, <Link>Service</Link> is recommended for enhanced document processing capabilities and better results."
              components={{
                Link: (
                  <LinkTargetBlank
    ...
    return (
      <div>
        ...
        {status.mode === 'local' && remoteConfig.setting_chatboxai_first && (
          <Typography variant="body2" sx={{ opacity: 0.5 }} className="pb-1">
            <Trans
              i18nKey="Due to local processing limitations, <Link>Service</Link> is recommended to enhance webpage parsing capabilities, especially for dynamic pages."
              components={{
                Link: (
                  <LinkTargetBlank
                    href={buildChatboxUrl(
