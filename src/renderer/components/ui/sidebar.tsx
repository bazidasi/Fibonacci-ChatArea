...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    // list-none/p-0/m-0: the app ships with Tailwind preflight disabled, so
    // the UA's disc markers and 40px indent would otherwise leak through.
    className={cn(
      "list-none m-0 flex w-full min-w-0 flex-col gap-1 p-0",
      className
    )}
    {...props}
  />
