    ...
    return (
      <div
        ...
        className={cn(
          ...
          'group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_bottom,color-mix(in_oklab,var(--muted)_50%,var(--background)),transparent)]',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_top,color-mix(in_oklab,var(--muted)_50%,var(--background)),transparent)]',
        'fade-in-0 animate-in',
        '[animation-duration:var(--animation-duration)]',
        className
      )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'group-data-[state=open]/collapsible-content:',
        'group-data-[state=closed]/collapsible-content:',
        'group-data-[state=open]/collapsible-content:[animation-duration:var(--animation-duration)]',
        'group-data-[state=closed]/collapsible-content:[animation-duration:var(--animation-duration)]',
        className
      )}
      {...props}
    >
