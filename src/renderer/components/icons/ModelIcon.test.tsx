...
describe('ModelIcon', () => {
  it.each(['chatboxai-3.5', 'chatboxai-4'])('uses the backgroundless Fibonacci AI icon for %s', (modelId) => {
  ...
  it('keeps the provider image fallback for other Fibonacci AI model ids without a model brand', () => {
