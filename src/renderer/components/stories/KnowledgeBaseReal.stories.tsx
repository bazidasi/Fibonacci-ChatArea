...
const knowledgeBases: KnowledgeBase[] = [
  ...
  {
    id: 102,
    name: 'Fibonacci AI support handbook',
  ...
  return (
    <Stack gap="lg">
      <SurfaceLabel
        ...
        description="Actual form controls used for create/edit knowledge base flows, including provider mode, parser selection, model selectors, read-only parser display, Fibonacci AI info, and destructive edit actions."
      />
