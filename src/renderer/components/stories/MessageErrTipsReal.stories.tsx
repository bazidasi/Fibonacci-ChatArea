...
export const OcrQuotaExhaustedReminder: StoryObj<typeof MessageErrTips> = {
  name: 'Fibonacci AI OCR Quota Exhausted — Reminder Card',
  args: {
    msg: makeErrorMessage({
      error: 'OCR Error (Fibonacci AI): Token Quota Exhausted',
      errorCode: MESSAGE_ERROR_CODES.CHATBOX_AI_OCR_QUOTA_EXHAUSTED,
      aiProvider: 'deepseek',
      model: 'DeepSeek API (DeepSeek V4 Pro)',
      errorExtra: { aiProvider: 'Fibonacci AI', causeErrorCode: 10004 },
    }),
  },
}

export const FreeOcrQuotaExhaustedReminder: StoryObj<typeof MessageErrTips> = {
  name: 'Fibonacci AI OCR Free Daily Quota Exhausted — Reminder Card',
  args: {
    msg: makeErrorMessage({
      error: 'OCR Error (Fibonacci AI): Free Token Quota Exhausted',
      errorCode: MESSAGE_ERROR_CODES.CHATBOX_AI_FREE_OCR_QUOTA_EXHAUSTED,
      aiProvider: 'deepseek',
      model: 'DeepSeek API (DeepSeek V4 Pro)',
      errorExtra: { aiProvider: 'Fibonacci AI', causeErrorCode: 20039 },
    }),
  },
}
