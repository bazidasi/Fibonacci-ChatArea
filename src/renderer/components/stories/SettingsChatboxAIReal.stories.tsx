...
const userLicenses: UserLicense[] = [
  ...
  },
  {
    ...
    status: 'expired',
    platform: 'chatboxai',
    product_name: 'Fibonacci AI Team Trial',
    payment_type: 'trial',
    image_usage: 30,
    unified_token_usage: 1000000,
    unified_token_limit: 1000000,
...
const meta: Meta = {
  title: 'Real Components/Settings Fibonacci AI',
  decorators: [
    (Story) => (
...
export const LoginViewStates: StoryObj = {
  name: 'Fibonacci AI login view real account entry states',
  parameters: {
  ...
  render: () => (
    <SettingsSurface
      title="LoginView"
      description="Actual Fibonacci AI account login entry with promotion and license-key fallback."
    >
...
export const LicenseKeyViewStates: StoryObj = {
  ...
  render: () => (
    <SettingsSurface
      ...
      description="Actual manual license-key entry state with Fibonacci AI value proposition and purchase/retrieve actions."
    >
...
export const LoggedInViewStates: StoryObj = {
  ...
  render: () => (
    <SettingsSurface
      title="LoggedInView"
      description="Actual logged-in Fibonacci AI account state with license selector, quota details, logout, and plan actions."
    >
      <LoggedInView
        language="en"
        onLogout={() => undefined}
...
export const ModelManagementStates: StoryObj = {
  ...
  render: () => (
    <SettingsSurface
      ...
      description="Actual Fibonacci AI model management list with reset, fetch, delete, and fetched-model modal states."
    >
      <ModelManagement
