  ...
  render: () => (
    <Stack gap="lg">
      <SurfaceLabel
        ...
        description="Shows which parser produced each attachment (Local / Fibonacci AI / MinerU). Inline attachments show the parser in the subtitle; session-retrieval (indexed) attachments hide it to make room for index status — the full parser + index info is shown in the click preview window instead."
      />
      <Box>
