...
export const ChatboxAIErrorMessageStates: StoryObj = {
  name: 'Fibonacci AI error message quota license file and web browsing states',
  parameters: {
  ...
  render: () => (
    <Stack gap="lg">
      <SurfaceLabel
        ...
        description="Actual localized Fibonacci AI service error copy with settings, plan, homepage, and parser action links."
      />
      <SeedLicensePlan name="Fibonacci AI Free" />
      <Paper withBorder radius="md" p="md">
        <Stack gap="sm">
          <Text size="sm">
            <ChatboxAIErrorMessage errorCode={10004} model="Fibonacci AI 4" />
          </Text>
          <Divider />
          <Text size="sm">
