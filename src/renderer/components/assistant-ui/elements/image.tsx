...
function ImagePreview({
  ...
  return (
    <div data-slot="image-preview" className={cn('relative min-h-32', containerClassName)}>
      ...
      {error ? (
        <div data-slot="image-preview-error" className="bg-muted/50 flex min-h-32 items-center justify-center p-4">
...
function ImageContentFilterError({ className, reason }: { className?: string; reason?: string }) {
  return (
    <div
      ...
      className={cn('bg-muted/50 flex min-h-32 flex-col items-center justify-center gap-2 p-4 text-center', className)}
    >
