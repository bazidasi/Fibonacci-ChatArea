...
const KnowledgeBaseDocuments: React.FC<KnowledgeBaseDocumentsProps> = ({ knowledgeBase }) => {
  ...
  // Parser types that should NOT show the "use Fibonacci AI" suggestion when they fail
  const PARSER_NO_SUGGESTION_LIST: string[] = ['mineru', 'chatbox-ai']

  // Check if we should show the Fibonacci AI suggestion for failed files
      ...
      <Box>
        <Paper withBorder radius="lg" p={0}>
          ...
          <Collapse in={isExpanded}>
            ...
            {/* Failed files banner - show Fibonacci AI suggestion only for local parser failures */}
