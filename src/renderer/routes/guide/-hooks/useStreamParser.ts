...
async function handleActivateLicense(
  ...
  const failureMessage = t(
    'Failed to activate the license key. You can try activating manually in **Settings**, or log in to the [ website](https://chatboxai.app) to view your license details.'
  )
