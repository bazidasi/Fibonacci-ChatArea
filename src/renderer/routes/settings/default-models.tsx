...
export function RouteComponent() {
  ...
  const chatboxAIAutoText = settings.licenseKey ? t('Auto (Use )')! : t('None')!
    ...
    <Stack p="md" gap="xl">
      ...
      <Stack gap="xs">
        ...
        <ModelSelector
          position="bottom-start"
          showAuto={true}
          autoText={settings.licenseKey ? t('Auto (Use )')! : t('None')!}
          width={320}
      ...
      <Stack gap="xs">
        ...
        <Text c="chatbox-tertiary" size="xs">
          {t('When selected, Chatbox will use this model instead of the automatic embedding model.')}
        </Text>
      </Stack>
      ...
      <Stack gap="xs">
        ...
        <Text c="chatbox-tertiary" size="xs">
          {t('When selected, Chatbox will use this model instead of the automatic reranking model.')}
        </Text>
      </Stack>
    </Stack>
  )
