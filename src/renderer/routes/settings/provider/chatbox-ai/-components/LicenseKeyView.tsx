                      ...
                      switch (errorCode) {
                        ...
                        case 'token_quota_exhausted':
                          return isChatboxAIPlanFree(licenseDetail)
                            ? t('You have no more quota left today.')
                            : t('You have no more quota left this month.')
                        default:
            ...
            <Paper shadow="xs" p="sm" withBorder>
              <Stack gap="sm">
                <Text fw="600" c="chatbox-brand">
                  {t(' offers a user-friendly AI solution to help you enhance productivity')}
                </Text>
                <Stack>
                  {[
