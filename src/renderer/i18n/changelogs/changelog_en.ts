...
5. Fibonacci AI settings moved from provider level to top-level settings for easier access
...
3. Auto-enable web search when using Fibonacci AI
...
1. Fibonacci AI supports Gemini multimodal output
...
1. Introduced Web Browsing capability. Fibonacci AI Models and Gemini 2.0 flash(API) can now be enabled to access real-time internet information, providing responses with cited sources
...
1. Fibonacci AI service users can now choose from a wider range of models
...
1. Fibonacci AI 3.5 now supports sending images.
...
- Built-in AI service "Fibonacci AI" - ready to use out of the box with fast, hassle-free setup.
