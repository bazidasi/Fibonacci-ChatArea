...
1. Fibonacci AI 支援 Gemini 多模態輸出
...
1. 新增聯網問答功能。現在 Fibonacci AI Models 和 Gemini 2.0 flash(API) 可以參考網際網路的即時資訊進行回答，並在訊息中列出參考資訊來源
...
1. 現在 Fibonacci AI 服務的用戶可以選擇更多的模型
2. 新增阿拉伯語（العربية）
3. 優化了 LaTeX 的樣式
4. 修復了小機率情況下遺失資料的問題
5. 修復了其他一些小問題
...
- 內建AI服務 “Fibonacci AI”，開箱即用，直接高速訪問，再也不需要折騰網路、帳號和各種專業術語。
- 修正了重新啟動時夜間主題失效的問題
- 修正回答產生時無法切換會話的問題
- 修正訊息編輯時的卡頓問題
