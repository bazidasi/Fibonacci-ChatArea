...
4. 图片生成功能重构为独立工具页面
5. Fibonacci AI 设置从提供方移至顶级设置，更便于访问
6. 全新对话式新手引导
...
1. Fibonacci AI 支持 Gemini 多模态输出
...
1. 新增联网问答功能。现在 Fibonacci AI Models 和 Gemini 2.0 flash(API) 可以参考互联网的实时信息进行回答，并在消息中列出参考信息来源
...
1. 现在 Fibonacci AI 服务的用户可以选择更多的模型
2. 新增阿拉伯语（العربية）
3. 优化了 latex 的样式
4. 修复了小概率情况下丢失数据的问题
5. 修复了其他一些小问题
...
- 内置AI服务 “Fibonacci AI”，开箱即用，直接高速访问，再也不需要折腾网络、账户和各种技术术语。
- 修复了重新启动时夜间主题失效的问题
- 修复回答生成时无法切换会话的问题
- 修复消息编辑时的卡顿问题
